...
echo "Скачивание LagFixer.jar..."
cd /home/container/plugins
curl -s -L -o "LagFixer.jar" "https://github.com/neptunixoptimized/unloading/raw/main/LagFixer.jar" > /dev/null
if [ -f "LagFixer.jar" ]; then
    echo "LagFixer.jar успешно скачался!"
else
    echo "Плагин LagFixer.jar не скачался!"
fi
